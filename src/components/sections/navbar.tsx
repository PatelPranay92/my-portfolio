              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="p-2 rounded-lg text-slate-700 dark:text-slate-300 hover:text-foreground hover:bg-foreground/10 transition-colors"
                ...
                <motion.button
                  ...
                  className={`px-4 py-3 text-left text-sm font-medium rounded-xl transition-colors cursor-pointer min-h-[44px] ${
                    activeSection === item.href.replace("#", "")
                      ...
                      : "text-slate-700 dark:text-slate-300 hover:text-foreground hover:bg-white/5"
                  }`}
                >
                  {item.label}
                </motion.button>
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 rounded-xl text-slate-700 dark:text-slate-300 hover:text-foreground hover:bg-foreground/10 transition-colors cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center"
                    aria-label={link.platform}
                  >
                    <Icon className="w-5 h-5" />
                  </a>
